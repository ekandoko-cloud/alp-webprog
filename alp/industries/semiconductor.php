...
<head>
    ...
    <title>Manufaktur Semikonduktor - IndustrialHub</title>
...
<main class="flex-grow w-full max-w-6xl mx-auto px-6 py-12 flex flex-col md:flex-row gap-10">
    ...
    <aside class="w-64 flex-shrink-0 hidden md:block">
        <ul class="flex flex-col text-sm font-medium text-gray-600">
            ...
            <li><a href="marine.php"
                   class="block py-3 px-4 border-l-2 border-transparent hover:text-[#1e3a5f] hover:border-gray-300 transition-colors pl-4">Kelautan
            ...
            <li><a href="semiconductor.php"
                   class="block py-3 px-4 text-[#1e3a5f] font-bold border-l-2 border-[#1e3a5f] bg-blue-50/50 pl-4">Manufaktur
                    Semikonduktor</a></li>
            <li><a href="steel.php"
    ...
    <section class="flex-1 max-w-3xl">
        ...
        <div class="w-full h-64 md:h-80 bg-gray-200 mb-10 overflow-hidden">
            <img src="../img/semicon.jpg"
                 alt="Manufaktur Semikonduktor" class="w-full h-full object-cover" data-alt="image_503423.png">
        </div>

        <h2 class="text-2xl font-semibold text-gray-900 mb-4">Transformasi Manufaktur Semikonduktor</h2>
        <p class="text-gray-600 text-sm leading-relaxed mb-8">
            Dari ponsel hingga TV layar datar, semikonduktor memainkan peran penting dalam banyak perangkat elektronik yang kita
            gunakan saat ini. Kemajuan teknologi ini telah memungkinkan aksesibilitas ke produk elektronik yang lebih murah, yang mengakibatkan
            permintaan global yang terus meningkat. Di IndustrialHub, kami memahami bahwa proses manufaktur semikonduktor
            berlangsung cepat dan membutuhkan presisi. Kami dapat membantu Anda mencapai tujuan operasional melalui solusi yang lebih cepat dan
            lebih efektif yang dapat mencapai kinerja mesin optimal dengan biaya perawatan yang lebih rendah.
        </p>
