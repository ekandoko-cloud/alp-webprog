...
<head>
    ...
    <title>Otomasi Robotik - IndustrialHub</title>
        ...
        <ul class="flex flex-col text-sm font-medium text-gray-600">
            ...
            <li><a href="paper.php"
                   class="block py-3 px-4 border-l-2 border-transparent hover:text-[#1e3a5f] hover:border-gray-300 transition-colors pl-4">Pulp
                    dan Kertas</a></li>
            <li><a href="robot.php"
                   class="block py-3 px-4 text-[#1e3a5f] font-bold border-l-2 border-[#1e3a5f] bg-blue-50/50 pl-4">Otomasi
                    Robotik</a></li>
    ...
    <section class="flex-1 max-w-3xl">
        ...
        <div class="w-full h-64 md:h-80 bg-gray-200 mb-10 overflow-hidden">
            <img src="../img/robot.jpg"
                 alt="Otomasi Robotik" class="w-full h-full object-cover" data-alt="image_50349b.png">
        </div>

        <h2 class="text-2xl font-semibold text-gray-900 mb-4">Solusi Otomasi Robotik Khusus</h2>
        <p class="text-gray-600 text-sm leading-relaxed mb-8">
            Di era Industri 4.0, otomasi robotik sedang meningkat. Karena presisi, keandalan, dan
            kecepatannya, otomasi robotik kini digunakan oleh banyak industri dalam peran kolaboratif untuk membantu memaksimalkan
            produktivitas, profitabilitas, dan efisiensi dalam bisnis mereka. Di IndustrialHub, kami menyediakan solusi
            otomasi robotik untuk berbagai basis pelanggan di berbagai sektor industri. Kami memiliki tim
            insinyur berdedikasi yang dapat membantu Anda menemukan solusi yang tepat sesuai dengan kebutuhan spesifik
            aplikasi Anda.
        </p>
