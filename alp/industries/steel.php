...
<head>
    ...
    <title>Industri Baja - IndustrialHub</title>
        ...
        <ul class="flex flex-col text-sm font-medium text-gray-600">
            ...
            <li><a href="semiconductor.php"
                   class="block py-3 px-4 border-l-2 border-transparent hover:text-[#1e3a5f] hover:border-gray-300 transition-colors pl-4">Manufaktur
                    Semikonduktor</a></li>
            <li><a href="steel.php"
                   class="block py-3 px-4 text-[#1e3a5f] font-bold border-l-2 border-[#1e3a5f] bg-blue-50/50 pl-4">Baja</a>
            </li>
        </ul>
    </aside>
    ...
    <section class="flex-1 max-w-3xl">
        ...
        <div class="w-full h-64 md:h-80 bg-gray-200 mb-10 overflow-hidden">
            <img src="../img/steel.jpg"
                 alt="Industri Baja" class="w-full h-full object-cover" data-alt="image_5030f8.png">
        </div>

        <h2 class="text-2xl font-semibold text-gray-900 mb-4">Proses Kritis dalam Operasi Baja</h2>
        <p class="text-gray-600 text-sm leading-relaxed mb-8">
            Industri baja beroperasi dalam berbagai kondisi ekstrem, seperti suhu tinggi, bahan kimia
            agresif, dan debu abrasif. Kondisi ini dapat menjadi tantangan untuk memastikan perawatan yang efektif dan kinerja
            puncak sambil memastikan keselamatan karyawan. Tim kami di IndustrialHub dapat membantu Anda mengatasi
            tantangan ini dan memenuhi kebutuhan kritis Anda dengan menyediakan operasi peralatan yang stabil di lingkungan
            yang paling keras, sambil memberikan peningkatan produktivitas dan efisiensi untuk mesin Anda.
        </p>
