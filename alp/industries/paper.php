...
<head>
    ...
    <title>Industri Pulp dan Kertas - IndustrialHub</title>
...
<main class="flex-grow w-full max-w-6xl mx-auto px-6 py-12 flex flex-col md:flex-row gap-10">
        ...
        <ul class="flex flex-col text-sm font-medium text-gray-600">
            ...
            <li><a href="palm.php"
                   class="block py-3 px-4 border-l-2 border-transparent hover:text-[#1e3a5f] hover:border-gray-300 transition-colors pl-4">Kelapa
                    Sawit</a></li>
            <li><a href="paper.php"
                   class="block py-3 px-4 text-[#1e3a5f] font-bold border-l-2 border-[#1e3a5f] bg-blue-50/50 pl-4">Pulp
                    dan Kertas</a></li>
            <li><a href="robot.php"
    ...
    <section class="flex-1 max-w-3xl">
        ...
        <p class="text-gray-600 text-sm leading-relaxed mb-8">
            Dengan banyaknya jenis pabrik, produk, dan proses, produksi pulp dan kertas adalah proses yang kompleks.
            Selain itu, lanskap persaingan dan peraturan ketat menjadi tantangan bagi banyak pemilik bisnis
            untuk tetap menguntungkan. Di IndustrialHub, kami menawarkan berbagai produk, serta solusi khusus yang
            sesuai dengan kebutuhan persis Anda di seluruh industri pulp dan kertas, sambil meningkatkan efisiensi secara
            ekonomis dan aman dengan keandalan yang maksimal.
        </p>
