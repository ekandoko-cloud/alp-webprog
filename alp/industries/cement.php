...
<head>
    ...
    <title>Industri Semen - IndustrialHub</title>
...
<main class="flex-grow w-full max-w-6xl mx-auto px-6 py-12 flex flex-col md:flex-row gap-10">
    ...
    <aside class="w-64 flex-shrink-0 hidden md:block">
        <ul class="flex flex-col text-sm font-medium text-gray-600">
            <li><a href="cement.php"
                   class="block py-3 px-4 text-[#1e3a5f] font-bold border-l-2 border-[#1e3a5f] bg-blue-50/50 pl-4">Semen</a>
            </li>
    ...
    <section class="flex-1 max-w-3xl">
        ...
        <p class="text-gray-600 text-sm leading-relaxed mb-8">
            Industri semen adalah fondasi dari industri konstruksi dan sangat diperlukan untuk pembangunan
            berkelanjutan di banyak negara. Industri ini memiliki proses yang kompleks dan sering beroperasi dalam kondisi
            yang berat. Di IndustrialHub, kami dapat memenuhi semua kebutuhan industri, mulai dari penggilingan bahan baku hingga
            produksi semen jadi, memastikan keandalan dan efisiensi optimal dalam operasi Anda melalui
