...
<head>
    ...
    <title>Industri Pertambangan - IndustrialHub</title>
...
<main class="flex-grow w-full max-w-6xl mx-auto px-6 py-12 flex flex-col md:flex-row gap-10">
    ...
    <aside class="w-64 flex-shrink-0 hidden md:block">
        <ul class="flex flex-col text-sm font-medium text-gray-600">
            ...
            <li><a href="mining.php"
                   class="block py-3 px-4 text-[#1e3a5f] font-bold border-l-2 border-[#1e3a5f] bg-blue-50/50 pl-4">Pertambangan</a>
            </li>
            <li><a href="oil.php"
    ...
    <section class="flex-1 max-w-3xl">
        ...
        <div class="w-full h-64 md:h-80 bg-gray-200 mb-10 overflow-hidden">
            <img src="../img/mining.webp"
                 alt="Industri Pertambangan" class="w-full h-full object-cover">
        </div>

        <h2 class="text-2xl font-semibold text-gray-900 mb-4">Efisiensi Operasional Maksimal di Pertambangan</h2>
        <p class="text-gray-600 text-sm leading-relaxed mb-8">
            Operasi pertambangan dijalankan dalam kondisi yang keras dan ekstrem, di lingkungan yang terpapar debu dan
            kotoran abrasif serta suhu ekstrem. Lingkungan ini menyulitkan, bahkan membahayakan tambang untuk memelihara
            mesin mereka dan rentan terhadap risiko konstan seperti cedera tempat kerja dan waktu henti tidak terencana. Anda
            akan menemukan produk kami berkinerja sesuai harapan dalam semua kondisi ini dan kami bekerja sama dengan Anda untuk meminimalkan
            risiko ini dan menyediakan lingkungan kerja yang lebih aman.
        </p>
