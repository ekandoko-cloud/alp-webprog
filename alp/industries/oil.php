...
<head>
    ...
    <title>Industri Minyak dan Gas - IndustrialHub</title>
...
<main class="flex-grow w-full max-w-6xl mx-auto px-6 py-12 flex flex-col md:flex-row gap-10">
    ...
    <aside class="w-64 flex-shrink-0 hidden md:block">
        <ul class="flex flex-col text-sm font-medium text-gray-600">
            ...
            <li><a href="oil.php"
                   class="block py-3 px-4 text-[#1e3a5f] font-bold border-l-2 border-[#1e3a5f] bg-blue-50/50 pl-4">Minyak
                    dan Gas</a></li>
            <li><a href="palm.php"
    ...
    <section class="flex-1 max-w-3xl">
        ...
        <div class="w-full h-64 md:h-80 bg-gray-200 mb-10 overflow-hidden">
            <img src="../img/oilgas.webp"
                 alt="Minyak dan Gas" class="w-full h-full object-cover" data-alt="image_5a1add.png">
        </div>

        <h2 class="text-2xl font-semibold text-gray-900 mb-4">Minyak dan Gas yang Ekonomis dan Optimal</h2>
        <p class="text-gray-600 text-sm leading-relaxed mb-8">
            Minyak dan gas adalah bahan baku yang digunakan untuk memproduksi pupuk, bahan bakar, karet sintetis, dan plastik
            yang masuk ke hampir semua yang kita gunakan dalam kehidupan sehari-hari, dari barang rumah tangga hingga barang industri
            berat. Lanskap operasi minyak dan gas alam selalu berubah; efisiensi ekonomi dan
            keberlanjutan adalah penggerak penting di sektor ini. Kekuatan IndustrialHub adalah keahliannya dalam menyediakan
            solusi terintegrasi yang mengoptimalkan kinerja mesin dan mendatangkan profitabilitas dalam proses Anda.
        </p>
