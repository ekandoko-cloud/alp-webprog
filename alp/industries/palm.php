...
<head>
    ...
    <title>Industri Kelapa Sawit - IndustrialHub</title>
...
<main class="flex-grow w-full max-w-6xl mx-auto px-6 py-12 flex flex-col md:flex-row gap-10">
        ...
        <ul class="flex flex-col text-sm font-medium text-gray-600">
            ...
            <li><a href="oil.php"
                   class="block py-3 px-4 border-l-2 border-transparent hover:text-[#1e3a5f] hover:border-gray-300 transition-colors pl-4">Minyak
                    dan Gas</a></li>
            <li><a href="palm.php"
                   class="block py-3 px-4 text-[#1e3a5f] font-bold border-l-2 border-[#1e3a5f] bg-blue-50/50 pl-4">Kelapa
                    Sawit</a></li>
            <li><a href="paper.php"
    ...
    <section class="flex-1 max-w-3xl">
        ...
        <div class="w-full h-64 md:h-80 bg-gray-200 mb-10 overflow-hidden">
            <img src="../img/palm.webp"
                 alt="Industri Kelapa Sawit" class="w-full h-full object-cover" data-alt="image_5a1a44.png">
        </div>

        <h2 class="text-2xl font-semibold text-gray-900 mb-4">Memenuhi Permintaan Global untuk Minyak Kelapa Sawit</h2>
        <p class="text-gray-600 text-sm leading-relaxed mb-8">
            Kelapa sawit adalah tanaman yang sangat produktif dan menawarkan hasil yang jauh lebih besar dengan biaya produksi yang lebih rendah daripada
            minyak nabati lainnya. Karena produksi global dan permintaan minyak kelapa sawit meningkat pesat, penting
            untuk merawat mesin Anda dan memaksimalkan produktivitas untuk memenuhi permintaan yang terus meningkat ini. Dalam hal memilih
            aplikasi yang sesuai dengan kebutuhan industri Anda, kami dapat menyusun strategi yang efektif dan memberikan
            solusi yang tepat untuk operasi Anda.
        </p>
